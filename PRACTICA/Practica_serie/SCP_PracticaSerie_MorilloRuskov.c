...
// //*** Calcula edad 
// int Calc_Edad() {
// 	return rand() % (MAX_EDAD + 1);
// }

// //*** Calcula probab incub
// int Calc_PeriodoIncubacion() {
// 	return rand() % 15;
// }

// //*** Calcula probab recuperacion
// int Calc_PeriodoRecuperacion() {
// 	return rand() % 15;
// }
...
// float Calc_Normal(int Media, int Varianza, int NumDatos) {
// // #define cK 100 // numero de datos que se suman para obtener distribucion normal
// 	int i,k;
// 	float Num, Aux, Cte1, Cte2;
// 	Cte1 = sqrt(Varianza) * sqrt((float) 12 / cK);
// 	Cte2 = (float) cK / 2;
// 	// srand(time(NULL));
...
// printf("Edad %i\n", Calc_Edad());
// printf("Edad %i\n", Calc_Edad());
// printf("Periodo incubacion %i\n", Calc_PeriodoIncubacion());
// printf("Periodo incubacion %i\n", Calc_PeriodoIncubacion());
// printf("Periodo incubacion %i\n", Calc_PeriodoIncubacion());
// printf("Periodo recuperacion %i\n", Calc_PeriodoRecuperacion());
// printf("Periodo recuperacion %i\n", Calc_PeriodoRecuperacion());
// printf("Periodo recuperacion %i\n", Calc_PeriodoRecuperacion());
// printf("0..1 %f\n",Calc_Probab_01());
// printf("0..1 %f\n",Calc_Probab_01());
// printf("0..1 %f\n",Calc_Probab_01());
// printf("Moris %f\n",Calc_ProbabMorision(10));
// printf("Moris %f\n",Calc_ProbabMorision(10));
// printf("Moris %f\n",Calc_ProbabMorision(65));
// printf("Moris %f\n",Calc_ProbabMorision(75));
// printf("Moris %f\n",Calc_ProbabMorision(90));

// fprintf(fmetr, "\nt=%i\n", t);
// fprintf(fmetr, "\tNumero de personas: %i\n", Metricas->NumPersonas);
// fprintf(fmetr, "\tSanos: %i\n", Metricas->PersSanas);
// fprintf(fmetr, "\tSin sintomas: %i\n", Metricas->PersContagSinSintomas);
// fprintf(fmetr, "\tCon sintomas: %i\n", Metricas->PersContagConSintomas);
// fprintf(fmetr, "\tRecuperados: %i\n", Metricas->PersRecuperadas);
// fprintf(fmetr, "\tFallecidos: %i\n", Metricas->PersMorisionadas);
// fprintf(fmetr, "\tR0: %.4f\n", Metricas->R0);
